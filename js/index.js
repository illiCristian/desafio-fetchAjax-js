...
let producto2 = new Producto(2,'Pokemones de apego','20 cm de alto, relleno de vellon siliconado',400,"https://i.ibb.co/v30CSMN/Whats-App-Image-2022-09-28-at-10-05-41-1.jpg",0);
let producto3 = new Producto(3,"Vaso Acrilico","Personalizado con vinilo holografico",500,"https://i.ibb.co/mvTRtfF/vaso.jpg",0);
let producto4 = new Producto(4,'Muñecos de apego','20 cm aprox, rellenos de vellon siliconado',400,"https://i.ibb.co/Lx7v4y5/Whats-App-Image-2022-09-28-at-10-05-42.jpg",0);
...
// const guardarJson = ("productos", JSON.stringify(productos));
...
const traerProductos = async () =>{
    try {
        ...
        console.log(error,'Error al cargar el archivo json');
    }finally{
        loadingData(false);
    }
}
const renderIndex = (productos) =>{
